...
#Define sets
mdl.I = pyo.Set(initialize=CaseStudy1Data_dpart.entrynode, doc='entrynode' )
mdl.J = pyo.Set(initialize=CaseStudy1Data_dpart.exitnode, doc='exitnode')

#Define parameters
mdl.c = pyo.Param(mdl.I, mdl.J, initialize=CaseStudy1Data_dpart.CostMatrix, doc='Cost of each arc' )
mdl.u=  pyo.Param(mdl.J, initialize=CaseStudy1Data_dpart.Upperd, doc='Upper Bound for each process')
